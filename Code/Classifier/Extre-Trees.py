...
for train, test in skf.split(X,y):
    ...
    print('ET:acc=%f,precision=%f,npv=%f,sensitivity=%f,specificity=%f,mcc=%f,f1=%f,roc_auc=%f'
...
yscore.to_csv('yscore_ET.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest = pd.DataFrame(data=ytest)
ytest.to_csv('ytest_ET.csv')